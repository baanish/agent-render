...
- `markdown` - GFM rendering with safe sanitization, copy/download/print flows from the shell, and syntax-highlighted CodeMirror fences that preserve source whitespace
